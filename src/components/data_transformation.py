...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):   # Getting data from data_ingestion.py
        try:
            ...
            preprocessing_obj = self.get_data_transformer_object()   # Calling the object
